...
def hba1c_ppbs_summarize(user_HBA1C, user_PPBS, report_HBA1C, report_PPBS):
    ...
    data = pd.read_excel('datasets/HBA1C_PPBS.xlsx')
    ...
    data['PPBS_Value'].fillna(data['PPBS_Value'].mean(), inplace=True)
    ...
    model.feature_names_in_ = ['HBA1C_Value', 'PPBS_Value']
    ...
    user_input = [[user_HBA1C, user_PPBS]]
    ...
    result = collection.find_one({"report_type01": report_HBA1C, "report_type02": report_PPBS})
    ...
    matching_records = collection.find({"report_type01": report_HBA1C, "report_type02": report_PPBS})
...
def ppbs_hba1c_summarize(user_PPBS, user_HBA1C, report_PPBS, report_HBA1C):
    return hba1c_ppbs_summarize(user_HBA1C, user_PPBS, report_HBA1C, report_PPBS)
